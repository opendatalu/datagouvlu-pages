...
The applicant can contact either directly the concerned administration or the open data portal team via our [contact form](/en/contact-us/).
...
A reuse request is not an [access to information request](https://guichet.public.lu/en/citoyens/citoyennete/archives-documents-administratifs/informations-detenues-institutions/communication-document-administrations.html).

The [list of previous requests](/en/datasets/requests-for-publication-of-data-in-open-data/) managed by the portal team is available as open data.
